...
export default {
  ...
  "kittyeyes sr": new Kittyeyes({
    ...
    passive: {
      name: "Cheshire Hire",
      description: "Upon player's turn, True Damage (:crossed_swords: x 0.2) enemies with Game Tag, grant :VUL."
    },
    advisor: {
      name: "Curiosity Killer",
  ...
  "kittyeyes ssr": new Kittyeyes({
    ...
    passive: {
      name: "Cheshire Hire",
      description: "Upon player's turn, True Damage (:crossed_swords: x 0.2) enemies with Game Tag, grant :VUL for 2 turns."
    },
    advisor: {
      name: "Curiosity Killer",
    ...
    passive: {
      name: "A Maid's Duty",
      description: "Upon the end of turn, Attack (:crossed_swords: x 0.5)(:crossed_swords: x 0.4)(:crossed_swords: x 0.3) targets with Game Tag multiple times based on number of stacks, remove Game Tag."
    },
    advisor: {
      name: "Have Some Tea",
    ...
    "1B": {
      ...
      description: "Heal (:crossed_swords: x 1.62) selected ally, grant 2 stacks :TEAR, clear 1 white orb."
    },
    "2B": {
  ...
  "kittyeyes skin": new Kittyeyes({
    ...
    passive: {
      ...
      description: "Upon player's turn, Armor Penetration (:crossed_swords: x 0.225)/(:crossed_swords: x 0.45)/(:crossed_swords: x 0.675) enemy with Game Tag, grant 1/2/3 stacks :VUL."
    },
    advisor: {
      name: "Barrage of Darts",
      description: "Armor Penetration (:crossed_swords: x 0.75) selected enemy. If enemy has more than 50% Armor before this skill cast, grant target CD +1. (CD: 4)"
    },
    "1B": {
      name: "Locked-on Shot",
      description: "Armor Penetration (:crossed_swords: x 0.75) selected enemy, grant Game Tag, 3 stacks max. Only 1 enemy can have Game Tag."
    },
    "2B": {
      name: "Steady Throw",
      description: "Armor Penetration (:crossed_swords: x 1.125) selected enemy, grant self :ENHANCE for 2 turns."
    },
    "4B": {
      name: "Concussive Ice Blasts",
      description: "Armor Penetration (:crossed_swords: x 1.125) all enemies. In addition, Armor Penetration (:crossed_swords: x 1.125)/(:crossed_swords: x 2.25)/(:crossed_swords: x 3.375) enemy with Game Tag. Remove all Game Tags."
    },
  }),
};
