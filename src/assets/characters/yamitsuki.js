...
export default {
  "yamitsuki r": {
    ...
    "advisor": {
      "name": "After Dark",
      "description": "Armor Penetration (x 1.3) selected enemy. (CD: 7)"
    },
    "1B": {
      "name": "Just Beat It",
      "description": "Armor Penetration (x 0.6) selected enemy, remove Taunt and Damage Reduction. \n_Damage Reduction: Upon incoming Attack, damage decreased by 30% for each stack. 3 stacks max_"
    },
    "2B": {
      "name": "Beat The Hush",
      "description": "Armor Penetration (x 1.3) selected enemy"
    },
    "4B": {
      "name": "Beat And Defeat",
      "description": "Armor Penetration (x 2.4) selected enemy"
    },
  },
  "yamitsuki sr": {
    "tier": "sr",
    ...
    "advisor": {
      "name": "After Dark",
      "description": "Armor Penetration (x 1.3) selected enemy. (CD: 6)"
    },
    "1B": {
      "name": "Just Beat It",
      "description": "Armor Penetration (x 0.6) selected enemy, remove Taunt and Damage Reduction. \n_Damage Reduction: Upon incoming Attack, damage decreased by 30% for each stack. 3 stacks max_"
  ...
  "yamitsuki ssr": {
    ...
    "advisor": {
      "name": "After Dark",
      "description": "Armor Penetration (x 1.3) selected enemy. (CD: 5)"
    },
    "1B": {
      "name": "Just Beat It",
      "description": "Armor Penetration (x 0.6) selected enemy, remove Taunt and Damage Reduction. \n_Damage Reduction: Upon incoming Attack, damage decreased by 30% for each stack. 3 stacks max_"
    ...
    "4B": {
      "name": "Beat And Defeat",
      "description": "Armor Penetration (x 2.4) selected enemy, grant 2 stacks Vulnerability and 2 stacks Exhaust for 2 turns. \n_Exhaust: Skill power decreased by 30% for each stack. 3 stacks max._ \n_Vulnerability: Upon incoming Attack, damage increased by 30% for each stack. 3 stacks max_"
    },
  },
}
