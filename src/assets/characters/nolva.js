...
import Nolva from './model/NolvaSP';
...
export default {
  'nolva r': new Nolva({
    ...
    '1B': {
      name: 'Sob Scene',
      description: 'True Damage (:crossed_swords: x 0.75) all enemies. Grant ally :VUL.',
    },
    '2B': {
  ...
  'nolva ssr': new Nolva({
    ...
    '1B': {
      name: 'Sob Scene',
      description: 'True Damage (:crossed_swords: x 0.75) all enemies. Grant all allies :VUL.',
    },
    '2B': {
      name: 'Love Scene Awry',
      description: 'True Damage (:crossed_swords: x 1.5) front row enemy, clear 1 black orb.',
    ...
    '4B': {
      name: 'Remake A Scene',
      description: 'True Damage (:crossed_swords: x 2) all enemies. Grant all allies and all enemies :VUL.',
    },
  }),
  ...
  'nolva sp': new NolvaSP({
    ...
    advisor: {
      ...
      description: 'Upon player\'s turn, all allies lose all of their Armor. Allies\' grant Armor effects increase by 60%.',
    },
    '1B': {
      name: 'Playing Card Soldiers',
      description: 'Armor Penetration (:crossed_swords: x 0.75) selected enemy, grant selected ally (:crossed_swords: x 1.2) Armor.',
    },
    '2B': {
      name: 'Hat Trick',
      description: 'Heal (:crossed_swords: x 0.9) all player characters, grant all player characters (:crossed_swords: x 1.2) Armor.',
    },
    '4B': {
      name: 'Mad Tea Party',
      description: 'Armor Penetration (:crossed_swords: x 1.5) all enemies, grant all player characters (:crossed_swords: x 2.4) Armor.',
    },
  }),
};
